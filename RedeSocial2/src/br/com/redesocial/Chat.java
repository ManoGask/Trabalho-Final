...
public class Chat {
    ...
    public void enviarMensagem() {
        ...
        try (PreparedStatement statement = conexao.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
            ...
            statement.setInt(3, (int) remetente.getIdUsuario());
            statement.setInt(4, (int) destinatario.getIdUsuario());
    ...
    public static List<Chat> listarMensagens(Usuario remetente, Usuario destinatario) {
        ...
        try (PreparedStatement statement = conexao.prepareStatement(query)) {
            statement.setInt(1, remetente.getIdUsuario());
            statement.setInt(2, destinatario.getIdUsuario());
            statement.setInt(3, destinatario.getIdUsuario());
            statement.setInt(4, remetente.getIdUsuario());
