...
import br.com.redesocial.Database;
        ...
        while (!sair) {
            ...
            switch (opcao1) {
                case 1:
                    ...
                    boolean sucessoCadastro = novoUsuario.fazerRegistro(emailCadastro, senhaCadastro, nomeCadastro, "");
                ...
                case 4:
                    ...
                    if (amigosEnviarMsg.isEmpty()) {
                        ...
                        if (escolha < 1 || escolha > amigosEnviarMsg.size()) {
                            ...
                            novaMensagem.setDataEnvio(agora);
                        ...
                        if (escolhaAmigo < 1 || escolhaAmigo > amigosVerMensagens.size()) {
                            ...
                            if (mensagens.isEmpty()) {
                                ...
                                for (Chat mensagem : mensagens) {
                                    ...
                                    System.out.println("Data/Hora: " + mensagem.getDTA_ENVVIO());
                                    System.out.println("-----");
                                }
                            }
                        }
