                        ...
                        if (escolhaAmigo < 1 || escolhaAmigo > amigosVerMensagens.size()) {
                            ...
                            if (mensagens.isEmpty()) {
                                ...
                                for (Chat mensagem : mensagens) {
                                    mensagensString.append("De: ").append(mensagem.getRemetente().getNome()).append("\n")
                                            .append("Para: ").append(mensagem.getDestinatario().getNome()).append("\n")
                                            .append("Mensagem: ").append(mensagem.getConteudo()).append("\n")
                                            .append("Data/Hora: ").append(mensagem.getDataEnvio()).append("\n-----\n");
                                }
