        ...
        while (!sair) {
            ...
            switch (opcao1) {
                case 1:
                    ...
                    boolean sucessoCadastro = novoUsuario.fazerRegistro(nomeCadastro, emailCadastro, senhaCadastro);
                        ...
                        if (escolhaAmigo < 1 || escolhaAmigo > amigosVerMensagens.size()) {
                            ...
                            if (mensagens.isEmpty()) {
                                ...
                                for (Chat mensagem : mensagens) {
                                    System.out.println("De: " + mensagem.getRemetente().getNome());
                                    System.out.println("Para: " + mensagem.getDestinatario().getNome());
                                    System.out.println("Mensagem: " + mensagem.getConteudo());
                                    System.out.println("Data/Hora: " + mensagem.getDataEnvio());
                                    System.out.println("-----");
                                }
                            }
                        }
